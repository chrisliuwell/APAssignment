...
public class DeleteMedicine extends javax.swing.JFrame {
    ...
    try {
        File inputFile = new File("//Users//machintoshhd//NetBeansProjects//APAssignment//src//Text//Medicine.txt");
        ...
        if (found && deletedLines > 0) {
            ...
            System.out.println("Only the medicine with ID " + medicineID + " was found, but no additional lines were deleted.");
        } else {
            outputFile.delete(); // Delete the temporary file
