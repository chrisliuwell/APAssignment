 ...
 * @author machintoshhd
 */
public class DeleteProcedure extends javax.swing.JFrame {

    /**
     * Creates new form DeleteProcedure
     */
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Delete Procedure");
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        String procedureID = jTextField2.getText(); // Get the procedure ID from the text field

    try {
        File inputFile = new File("//Users//machintoshhd//NetBeansProjects//APAssignment//src//Text//Procedure.txt");
        File outputFile = new File("Procedure Form.txt");
        ...
        while ((line = reader.readLine()) != null) {
            if (line.startsWith("Procedure ID: " + procedureID)) {
                found = true;
            }

            if (!found || deletedLines >= 11) {
        ...
        if (found && deletedLines > 0) {
            ...
            System.out.println("Procedure with ID " + procedureID + " deleted successfully.");
        } else if (found && deletedLines == 0) {
            outputFile.delete(); // Delete the temporary file
            System.out.println("Only the procedure with ID " + procedureID + " was found, but no additional lines were deleted.");
        } else {
            outputFile.delete(); // Delete the temporary file
            System.out.println("Procedure with ID " + procedureID + " not found.");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteProcedure.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteProcedure().setVisible(true);
            }
        });
    }
