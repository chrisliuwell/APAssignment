...
public class DeletePatientDetails extends javax.swing.JFrame {
    ...
    try {
        File inputFile = new File("//Users//machintoshhd//NetBeansProjects//APAssignment//src//Text//Patient Details.txt");
        File outputFile = new File("Patient Details.txt");
        ...
        if (found && deletedLines > 0) {
            ...
            System.out.println("Only the patient with ID " + patientID + " was found, but no additional lines were deleted.");
        } else {
            outputFile.delete(); // Delete the temporary file
