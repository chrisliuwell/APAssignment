 ...
 */
public class EditProcedure extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Edit Procedure");
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
            ...
            if (!patientDetails.equals(editedDetails)) {
                ...
                if (evt.getSource() == Submit) {
                    ...
                    if (option == JOptionPane.YES_OPTION) {
                        boolean saveSuccessful = editPatientDetails(procedureID, editedDetails);
        ...
        private boolean editPatientDetails(String procedureID, String newDetails) {
            try {
                File inputFile = new File("C:\\Users\\LORELYN\\OneDrive\\Desktop\\APAssignment\\src\\Text\\Procedure Form.txt");
                File tempFile = new File("C:\\Users\\LORELYN\\OneDrive\\Desktop\\APAssignment\\src\\Text\\Temp Procedure Form.txt");
                ...
                while ((line = br.readLine()) != null) {
                    if (line.equals("Procedure ID: " + procedureID)) {
                        ...
                        bw.write(newDetails);
                        bw.newLine();
                    } else if (line.startsWith("Procedure ID: ")) {
        ...
        bw.close();
            ...
            if (patientFound) {
                ...
                System.out.println("Procedure ID not found in the file.");
                return false;
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditProcedure.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditProcedure().setVisible(true);
            }
        });
    }
