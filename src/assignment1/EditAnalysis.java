 ...
 */
public class EditAnalysis extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(Submit, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            if (!patientDetails.equals(editedDetails)) {
                ...
                if (evt.getSource() == Submit) {
                    ...
                    if (option == JOptionPane.YES_OPTION) {
                        boolean saveSuccessful = editPatientDetails(analysisID, editedDetails);
    ...
    private boolean checkPatientExists(String analysisID) {
            try (BufferedReader br = new BufferedReader(new FileReader("../APAssignment/src/Text/Analysis Form.txt"))) {
                String line;
    ...
    private boolean editPatientDetails(String analysisID, String newDetails) {
            try {
                File inputFile = new File("../APAssignment/src/Text/Analysis Form.txt");
                File tempFile = new File("../APAssignment/src/Text/Temp Analysis Form.txt");
                ...
                while ((line = br.readLine()) != null) {
                    if (line.equals("Analysis ID: " + analysisID)) {
                        ...
                        bw.write(newDetails);
                        bw.newLine();
                    } else if (line.startsWith("Analysis ID: ")) {
        ...
        bw.close();
            ...
            if (patientFound) {
                ...
                System.out.println("Analysis details updated successfully.");
                return true;
            } else {
                System.out.println("Analysis ID not found in the file.");
                return false;
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditAnalysis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditAnalysis().setVisible(true);
            }
        });
    }
