 ...
 * @author machintoshhd
 */
public class DeleteTreatmentDetails extends javax.swing.JFrame {

    /**
     * Creates new form DeleteTreatmentDetails
     */
    public DeleteTreatmentDetails() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Delete Treatment Details");
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        String treatmentID = jTextField2.getText(); // Get the treatment ID from the text field

    try {
        File inputFile = new File("//Users//machintoshhd//NetBeansProjects//APAssignment//src//Text//Treatment Details.txt");
        File outputFile = new File("Treatment Details.txt");
        ...
        while ((line = reader.readLine()) != null) {
            if (line.startsWith("Treatment ID: " + treatmentID)) {
                found = true;
            }

            if (!found || deletedLines >= 6) {
                // Write the line to the temporary file if it doesn't match the treatment ID
                writer.write(line);
                writer.newLine();
            } else {
                deletedLines++;
        ...
        if (found && deletedLines > 0) {
            ...
            System.out.println("Treatment with ID " + treatmentID + " deleted successfully.");
        } else if (found && deletedLines == 0) {
            outputFile.delete(); // Delete the temporary file
            System.out.println("Only the treatment with ID " + treatmentID + " was found, but no additional lines were deleted.");
        } else {
            outputFile.delete(); // Delete the temporary file
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteTreatmentDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteTreatmentDetails().setVisible(true);
            }
        });
    }
